...
public class ExerciciosAulaTresIfElse {
    ...
    public static void oitavo() {
        ...
        if (primeiroValor < segundoValor && primeiroValor < segundoValor) {
            ...
            System.out.println("Se o valor dos produtos for igual, vá conforme seu gosto pessoal.");
        }
    }
    ...
    public static void vigesimoSexto() {
    ...
    public static void vigesimoSetimo() {
    ...
    public static void vigesimoOitavo() {
        ...
        double precoCarne = 0, valorTotalSemDesconto = 0, valorTotal = 0, valorDesconto = 0, valorTotalComDesconto = 0;
        ...
        if (tipoPagamento.equalsIgnoreCase("ct")) {
            valorTotalComDesconto = valorTotalSemDesconto - (valorTotalSemDesconto / 100) * 5;
            valorTotal = valorTotalComDesconto;
            valorDesconto = valorTotalSemDesconto - valorTotalComDesconto;
